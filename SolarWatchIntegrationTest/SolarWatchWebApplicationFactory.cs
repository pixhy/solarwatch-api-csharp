...
public class SolarWatchWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public class MyControllerIntegrationTest
    {
        ...
        {
            var response = await _client.GetAsync("http://localhost:5175/api/v1/SunriseAndSunset?city=Budapest&date=2024-11-05");

            response.EnsureSuccessStatusCode();


            var result = new SunriseAndSunset(){Id = 1, CityId = 1, City = new City(){Country = "HU", Id = 1, Name = "Budapest", Longitude = 19.0403594, Latitude = 47.4979937, State = null}, Sunset = TimeOnly.Parse("15:22:07"), Sunrise = TimeOnly.Parse("05:32:45"), Date = DateOnly.Parse("2024-11-05")};
